    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-10 d-flex justify-content-between">
            <div class="project-image-container">
                <img src="{{asset ('storage/' . $project->cover_image) }}" alt="fnf" class="project-image img-fluid rounded w-100 mb-5 shadow">
            </div>
            ...
            <div class="card shadow d-flex flex-row">
                ...
                <div class="p-3">
                    ...
                    <div class="card-body d-flex justify-content-between">
                        <div class="project-image-container">
                            <img src="{{asset ('storage/' . $project->cover_image) }}" alt="fnf" class="project-image img-fluid rounded mb-5 shadow">
                        </div>
        
                        <div class="container">
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="technologies d-flex flex-wrap py-3">
                                ...
                                <li class="list-group-item py-3">
                                    <strong> Type: {{$project->type->name ?? 'Undefined Type'}}</strong>
                                </li>    
                                <li class="list-group-item py-3">
                                    <strong>Slug:</strong> {{ $project->slug }}
                                </li>
